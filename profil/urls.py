...
urlpatterns = [
    ...
    path('tambah-pangkat/', views.tambah_pangkat, name='tambah_pangkat'),
    path('edit-pangkat/<int:pangkat_id>/', views.edit_pangkat, name='edit_pangkat'),
    path('hapus-pangkat/<int:pangkat_id>/', views.hapus_pangkat, name='hapus_pangkat'),
    ...
    path('validasi-serdos/', views.validasi_serdos, name='validasi_serdos'),
    path('validasi-serdos/<int:id>/putuskan/', views.putuskan_validasi_serdos, name='putuskan_validasi_serdos'),
